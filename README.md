# Salcode fork of reveal.js [![Build Status](https://travis-ci.org/hakimel/reveal.js.svg?branch=master)](https://travis-ci.org/hakimel/reveal.js) <a href="https://slides.com?ref=github"><img src="https://s3.amazonaws.com/static.slid.es/images/slides-github-banner-320x40.png?1" alt="Slides" width="160" height="20"></a>
...
- Ability to create a full screen image with original image ratio (background-size: constrain).
	- `<section data-background="images/my-image.jpg" data-state="fe-full-screen-image">`
	- This state also hides the persistant-credit
...
- Hide on-screen control display arrows by default
